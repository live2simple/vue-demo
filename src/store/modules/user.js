    ...
    getInfo: function ({commit, state}, roleId) {
        return new Promise((resolve, reject) => {
            ...
            getAction('/sys/user/getUserInfo', {roleId}).then(response => {
                ...
                const {sysUser, sysRole, sysRoles, sysOrg, routes, authorities, avatar, permissions:permissionsRes} = data
                ...
                permissions = permissions ? permissions : permissionsRes
